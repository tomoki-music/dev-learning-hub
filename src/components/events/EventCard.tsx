...
/** One event, rendered as a card. Pure presentation from a prop — a Server
 * Component, since nothing here needs to run in the browser. */
    ...
    >
      ...
      <dl className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1.5 text-sm text-text-muted">
        ...
        <dd className="text-text-primary">
          ...
          {status === "RECRUITING" && (
            <span className="ml-1 text-brand-gold-dark">（残り{remaining}名）</span>
          )}
        </dd>
      </dl>
